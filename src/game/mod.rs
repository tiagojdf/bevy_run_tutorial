...
fn setup_in_game_system(mut commands: Commands, asset_server: Res<AssetServer>) {
    // Headline
...
///
/// Update Main Menu
fn update_in_game_system(mut state: ResMut<State<AppState>>, keyboard_input: Res<Input<KeyCode>>) {
